...
static u8 *hid_get_descriptor(usb_setup_req_t *req, usbd_speed_type_t speed, u16 *len);

/* Private variables ---------------------------------------------------------*/

/* USB Standard Device Descriptor */
static u8 usbd_hid_dev_desc[USB_LEN_DEV_DESC]  = {
...
static u8 usbd_hid_lang_id_desc[USB_LEN_LANGID_STR_DESC]  = {
...
static u8 usbd_hid_mfg_string_desc[HID_MFG_STRING_DESC_SIZE]  = {
...
static u8 usbd_hid_hs_product_string_desc[HID_PRODUCT_STRING_DESC_SIZE]  = {
...
/* USB Standard Product String Descriptor for high-speed mode */
static u8 usbd_hid_fs_product_string_desc[HID_PRODUCT_STRING_DESC_SIZE]  = {
	HID_PRODUCT_STRING_DESC_SIZE,               	/* bLength */
	USB_DESC_TYPE_STRING,                           /* bDescriptorType */
	'R', 0,                                         /* bString, UNICODE */
	'e', 0,
...
static u8 usbd_hid_device_qualifier_desc[USB_LEN_DEV_QUALIFIER_DESC] = {
...
static u8 usbd_hid_sn_string_desc[HID_SN_STRING_DESC_SIZE]  = {
